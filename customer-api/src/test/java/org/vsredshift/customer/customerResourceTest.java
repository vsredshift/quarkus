...
public class customerResourceTest {
    ...
    final static String BASE_API = "/api/customers";
    ...
    public void getById() {
        ...
        Customer got = given()
                .when().get(BASE_API + "/{customerId}", saved.getCustomerId())
                .then()
                .statusCode(200)
                .extract().as(Customer.class);
    ...
    private Customer createCustomer() {
        ...
        customer.setEmail(RandomStringUtils.randomAlphabetic(10) + "@glab.com");
